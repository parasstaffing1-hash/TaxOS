...
from taxos.application.calculators.evaluator import (
    AsyncSafeEvaluator,
    FormulaError,
    evaluate_calculator,
)
from taxos.application.calculators.factory import CalculatorFactory
from taxos.domain.calculators.schema import (
    CalculatorConfig,
    FormulaConfig,
    InputField,
    OutputConfig,
...
async def test_evaluate_calculator() -> None:
    config = CalculatorConfig(
        ...
        formulas=[FormulaConfig(id="c", expression="a + b", is_result=True)],
