...
async def list_calculators(factory: CalculatorFactory = Depends(get_factory)) -> list[CalculatorConfig]:
...
async def create_calculator(config: CalculatorConfig, factory: CalculatorFactory = Depends(get_factory)) -> CalculatorConfig:
...
async def update_calculator(slug: str, config: CalculatorConfig, factory: CalculatorFactory = Depends(get_factory)) -> CalculatorConfig:
...
async def delete_calculator(slug: str, factory: CalculatorFactory = Depends(get_factory)) -> None:
...
async def get_calculator_config(slug: str, factory: CalculatorFactory = Depends(get_factory)) -> CalculatorConfig:
